// ref: https://raw.githubusercontent.com/developer-1px/adorable-css/master/packages/vite/src/core/makeValue.ts
...
export const makeColor = (value = 'transparent') => {
  ...
  if (value.startsWith('#')) return makeHEX(value);
  ...
  (value || '')
    ...
    .map((value, index) => {
      ...
      switch (index) {
        ...
        case 1: {
          return `line-height:${+value < 4 ? makeNumber(+value) : px(value)}`;
        }
        case 2: {
